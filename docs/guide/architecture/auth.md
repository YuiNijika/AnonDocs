...
return [
    'auth' => [
        ...
        'refresh_secret' => getenv('JWT_REFRESH_SECRET') ?: getenv('JWT_SECRET') ?: 'anon_secret_key',
        'refresh_ttl' => 604800,
        ...
        'guards' => [
            ...
            'admin' => [
                'secret' => getenv('JWT_ADMIN_SECRET') ?: getenv('JWT_SECRET') ?: 'anon_secret_key',
                'ttl' => 7200,
                'token_sources' => ['header', 'cookie'],
                'cookie_enabled' => true,
                'cookie_name' => 'admin_access_token',
                'refresh_enabled' => true,
                'refresh_secret' => getenv('JWT_ADMIN_REFRESH_SECRET') ?: getenv('JWT_REFRESH_SECRET') ?: getenv('JWT_ADMIN_SECRET') ?: 'anon_secret_key',
                'refresh_ttl' => 604800,
